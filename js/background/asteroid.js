...
window.asteroid = (function(){
  ...
  exports.init = function(host){
    ...
    var onLogin = function(){
      ...
      Asteroid.utils.multiStorage.get(tokenName).then(function(token){
        if (token){
      ...
      asteroidDDP.subscribe('userPrivateData')
        ...
        .then(function() {
          return exports.call('getNewTabTopicId', {
            subject: AccountHelper.getUsername() + '\'s' + ' Knotes from Chrome',
    ...
    var onLogout = function(){
      ...
      exports.userId = null;
      exports.loggedIn = null;
      chrome.storage.local.set({loginToken: null});
      _topicId = null;
      chrome.runtime.sendMessage({
        msg: 'logout'
      }, $.noop);
  ...
  exports.loginSuccess = function(res){
    var tokenName = asteroidDDP._host + "__" + asteroidDDP._instanceId + "__login_token__";
    var tokenObject = {};
    tokenObject[tokenName] = res.token;
    Asteroid.utils.multiStorage.set(tokenObject);
